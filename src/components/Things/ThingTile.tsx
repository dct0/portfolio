  ...
  return (
    <article className={cn(thingTile({ size, className }))}>
      <Dialog>
        ...
        <DialogContent className="top-[100%] flex h-2/3 translate-y-[-100%] flex-col gap-0 overflow-y-auto rounded-b-none rounded-t-xl p-0 focus-visible:outline-none sm:rounded-b-none sm:rounded-t-xl">
          {file ? (
            <img
